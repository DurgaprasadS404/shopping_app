...
class _HomePageState extends State<HomePage> {
  ...
  final List<Product> products = [
    Product(
        ...
        price: 256.00,
        imageUri:
            "https://freepngimg.com/thumb/chair/10-2-chair-free-png-image.png",
        rating: 4.5),
    Product(
        name: "Morbi Chair",
        price: 284.00,
        imageUri:
            "https://freepngimg.com/thumb/chair/1-2-chair-png-picture.png",
        rating: 4.8),
    Product(
        name: "Pretium Chair",
        price: 232.00,
        imageUri:
            "https://freepngimg.com/thumb/chair/2-2-chair-download-png.png",
        rating: 4.3),
    Product(
        name: "Blandit Chair",
        price: 224.00,
        imageUri:
            "https://freepngimg.com/thumb/chair/3-2-chair-transparent.png",
        rating: 4.1),
    Product(
        name: "Tortor Chair",
        price: 256.00,
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(
                left: 32.0, right: 32.0, top: 32.0, bottom: 24),
            child: Row(
          ...
          Padding(
            padding: const EdgeInsets.only(
                left: 32.0, right: 32.0, top: 32.0, bottom: 0),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Color(0xff191B24).withOpacity(0.6)),
                ),
